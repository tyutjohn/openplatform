...
let app = new Vue({
    ...
    methods: {
        ...
        get:function(){
            ...
            this.$http.get("/school/queryList", {
                params: {
                    accessToken: token
                }
            }).then(
        ...
        loadData:function(){
            let self=this;
            let token=document.querySelector('#token').value;
            this.$http.get("/academy/queryList", {
                params: {
                    accessToken: token
                }
            }).then(
        ...
        edit: function () {
            if (this.$refs.avatarInput.files.length !== 0) {
                ...
                this.$http.put('/user/updateAvatar/'+file,image,{
        ...
        form1:function(){
            ...
            this.$http.put('/user/infor',formData,{'Content-Type':'Multipart/form-data'}).then(
                function(res){
                    if(res.body.code==0){
